...
[TestFixture]
public class UnbreakableFactoryTest {
    private UnbreakableBlockFactory factory;
    private UnbreakableBlock exampleBlock;
    
    public UnbreakableFactoryTest() {
        factory = new UnbreakableBlockFactory();
        exampleBlock =  new UnbreakableBlock(
