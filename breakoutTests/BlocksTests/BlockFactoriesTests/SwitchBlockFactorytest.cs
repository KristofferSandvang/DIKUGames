...
[TestFixture]
public class SwitchBlockFactoryTest {
    private SwitchBlockFactory factory;
    private SwitchBlock exampleBlock;

    public SwitchBlockFactoryTest() {
        factory = new SwitchBlockFactory();
        exampleBlock =  new SwitchBlock(
